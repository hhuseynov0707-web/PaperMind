...
const I18N = {
  az: {
    ...
    nav_pricing: 'Qiymətlər', nav_search: 'Axtarış', nav_browse: 'Vərəqlə',
  ...
  ru: {
    ...
    nav_pricing: 'Цены', nav_search: 'Поиск', nav_browse: 'Листать',
  ...
  en: {
    ...
    nav_pricing: 'Pricing', nav_search: 'Search', nav_browse: 'Browse',
